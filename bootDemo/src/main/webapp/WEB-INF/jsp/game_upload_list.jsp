...
<head>
    <head>
        <!-- 引入样式 -->
        <link rel="stylesheet" href="../../../api/static/js/vue/elementui/index.css">
    </head>
    <style>
...
<!-- 先引入 Vue -->
<script src="../../../api/static/js/vue/vue.js"></script>
<script src="../../../api/static/js/vue/vueComponent.js"></script>
<script src="../../../api/static/js/vue/vue-router.js"></script>
<script src="../../../api/static/js/vue/api.js"></script>
<!-- 引入组件库 -->
<script src="../../../api/static/js/vue/elementui/index.js"></script>
